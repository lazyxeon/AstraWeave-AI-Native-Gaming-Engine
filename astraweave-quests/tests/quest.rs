...
fn test_quest_empty_title() {
    let quest = Quest {
        title: "".into(),
        steps: vec![QuestStep { description: "Step 1".into(), completed: false }],
    };
...
fn test_quest_completion() {
    let quest = Quest {
        title: "Test".into(),
        steps: vec![
            QuestStep { description: "Step 1".into(), completed: true },
            QuestStep { description: "Step 2".into(), completed: true },
        ],
    };
