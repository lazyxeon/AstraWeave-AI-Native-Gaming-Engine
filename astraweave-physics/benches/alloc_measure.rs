...
// A tiny counting allocator. Lives in the bench to avoid a runtime dep on
// astraweave-ecs from astraweave-physics (kept optional). Inner allocator is
// `System` by default, `MiMalloc` with `--features fast-alloc`.
