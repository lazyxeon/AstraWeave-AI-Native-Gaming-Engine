...
impl PhysicsStepProfile {
    ...
    pub fn broad_phase_percent(&self) -> f32 {
        ...
        (self.broad_phase_duration.as_nanos() as f32 / self.total_duration.as_nanos() as f32) * 100.0
    }
    ...
    pub fn narrow_phase_percent(&self) -> f32 {
        ...
        (self.narrow_phase_duration.as_nanos() as f32 / self.total_duration.as_nanos() as f32) * 100.0
    }
    ...
    pub fn integration_percent(&self) -> f32 {
        ...
        (self.integration_duration.as_nanos() as f32 / self.total_duration.as_nanos() as f32) * 100.0
    }
}
