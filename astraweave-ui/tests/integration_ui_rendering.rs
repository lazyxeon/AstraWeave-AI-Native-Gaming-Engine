use astraweave_gameplay::{Inventory, QuestLog, RecipeBook, Stats};
use astraweave_ui::{draw_ui, Accessibility, MenuAction, MenuManager, UiFlags};
use egui::Context;
use glam::Vec3;
