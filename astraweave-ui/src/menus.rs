...
pub fn show_settings_menu(
    ...
    // Centered settings window (tall enough to show ALL content including Apply/Cancel/Back buttons)
    egui::Window::new("settings_menu")
        .title_bar(false)
        .resizable(true) // Allow user to resize if needed
        .default_size(egui::vec2(700.0, 1100.0)) // Tall enough for all controls + buttons
        .anchor(egui::Align2::CENTER_CENTER, egui::vec2(0.0, 0.0))
