...
use astraweave_audio::{
    dialogue_runtime::{DialogueAudioMap, DialoguePlayer, load_dialogue_audio_map},
    engine::AudioEngine,
    voice::{VoiceBank, VoiceSpec, TtsAdapter},
};
...
impl TtsAdapter for MockTtsAdapter {
    fn synth_to_path(&self, voice_id: &str, text: &str, out_path: &str) -> Result<()> {
        ...
        // Log for debugging
        println!("MockTTS: Generated {} for voice '{}' text '{}'", out_path, voice_id, text);
