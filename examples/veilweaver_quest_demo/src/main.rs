...
fn main() {
    ...
    println!("  Player Health: {}/{}", stats.player_health, stats.player_max_health);
    ...
    println!("  Echo Currency: {} (expect 70 + 100 = 170)", stats.echo_currency);
    println!("  Abilities: {:?} (expect [\"Echo Dash\"])\n", level.player.abilities);
    ...
    println!("  Player Health: {}/{}", final_stats.player_health, final_stats.player_max_health);
    println!("  Echo Currency: {}", final_stats.echo_currency);
    println!("  Abilities Unlocked: {:?}", level.player.abilities);
    println!("  Anchors Repaired: {}/{}", final_stats.anchors_repaired, final_stats.anchors_total);
