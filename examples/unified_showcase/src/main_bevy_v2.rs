...
impl ShowcaseApp {
    ...
    fn create_render_pipeline(&mut self) {
        ...
        println!(
            "✅ Render pipeline created with {} materials",
            self.materials.len()
        );
    }
    ...
    fn setup_scene(&mut self) {
        ...
        let tree_positions = vec![
            ...
            Vec3::new(15.0, 0.0, -28.0),
            Vec3::new(20.0, 0.0, -22.0),
            Vec3::new(-25.0, 0.0, 10.0),
            Vec3::new(-18.0, 0.0, 15.0),
            Vec3::new(22.0, 0.0, 12.0),
            Vec3::new(28.0, 0.0, 18.0),
