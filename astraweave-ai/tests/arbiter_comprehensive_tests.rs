...
use astraweave_core::{
    ActionStep, CompanionState, EnemyState, IVec2, PlayerState, PlanIntent, WorldSnapshot,
};
...
async fn test_llm_success_increments_mode_transitions_metric() {
    ...
    assert_eq!(arbiter.mode(), AIControlMode::ExecutingLLM { step_index: 1 }); // Should be in ExecutingLLM mode
