...
impl TokenCounter {
    ...
    pub fn count_tokens(&self, text: &str) -> Result<usize> {
        ...
        // Update cache (with size limit)
        {
            ...
            if cache.len() < 10_000 { // Limit cache size
    ...
    fn update_stats(&self, token_count: usize, cache_hit: bool) {
        ...
        stats.avg_tokens_per_request = stats.total_tokens_counted as f32 / stats.total_requests as f32;
...
impl TokenBudget {
    ...
    pub fn available_tokens(&self) -> usize {
        ...
        self.total_budget.saturating_sub(self.used_tokens).saturating_sub(reserved)
    }
