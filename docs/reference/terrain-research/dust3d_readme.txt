...
URL Source: https://raw.githubusercontent.com/huxingyi/dust3d/master/README.md
...
2. Run `git tag 1.0.0-rc.` 3. Run `git push origin 1.0.0-rc.` 4. Wait Actions/release finish and download all the Artifacts 5. Goto `Tags/1.0.0-rc.` and create release from tag 6. Title the release as `1.0.0-rc.` 7. Copy description from CHANGELOGS 8. Drag the Artifacts: `dust3d-1.0.0-rc..zip`, `dust3d-1.0.0-rc..AppImage (Extracted)`, `dust3d-1.0.0-rc..dmg (Extracted)` to binaries. 9. Publish release ## License Dust3D is licensed under the MIT License - see the [LICENSE](https://github.com/huxingyi/dust3d/blob/master/LICENSE) file for details.
