...
Sub-phase 3 Mediator Brush Cleanup-D — erosion chunk seam artifacts per ChatGPT-broadened scope ("height-mutation chunk-boundary continuity"): NOT STARTED (gated on full material library coverage + 8/8 brush modes per Andrew-gate (d) D-2).
