...
async fn test_get_files_success_texture() {
    ...
    assert!(files.maps.contains_key("Diffuse"), "Should have Diffuse map");
...
async fn test_get_files_404_error() {
    ...
    let mock = server.mock("GET", "/files/nonexistent")
        .with_status(404)
        .with_header("content-type", "application/json")
...
async fn test_get_files_invalid_json() {
    ...
    let mock = server.mock("GET", "/files/bad_json")
        .with_status(200)
        .with_header("content-type", "application/json")
...
async fn test_get_files_empty_response() {
    ...
    let mock = server.mock("GET", "/files/empty")
        .with_status(200)
        .with_header("content-type", "application/json")
        .with_body("{}")
        .create_async()
...
async fn test_get_files_rate_limit_error() {
    ...
    let mock = server.mock("GET", "/files/rate_limited")
        .with_status(429)
        .with_header("content-type", "application/json")
...
async fn test_get_files_server_error() {
    ...
    let mock = server.mock("GET", "/files/server_error")
        .with_status(500)
        .with_header("content-type", "application/json")
...
async fn test_get_files_complex_structure() {
    ...
    let mock = server.mock("GET", "/files/complex_hdri")
        .with_status(200)
        .with_header("content-type", "application/json")
        .with_body(r#"{
            "hdri": {
    ...
    assert!(files.maps.contains_key("tonemapped"), "Should have tonemapped map");
...
async fn test_get_info_404_error() {
    ...
    let mock = server.mock("GET", "/info/nonexistent")
        .with_status(404)
        .with_body(r#"{"error": "Asset not found"}"#)
        .create_async()
        .await;
...
async fn test_get_info_minimal_response() {
    ...
    let mock = server.mock("GET", "/info/minimal")
        .with_status(200)
        .with_header("content-type", "application/json")
        .with_body(r#"{
            "name": "Minimal Asset"
...
async fn test_get_info_invalid_json() {
    ...
    let mock = server.mock("GET", "/info/bad_json")
        .with_status(200)
        .with_header("content-type", "application/json")
        .with_body("not json")
        .create_async()
...
async fn test_resolve_texture_basic() {
    ...
    let result = client.resolve_texture(
        "test_texture",
        "2k",
...
async fn test_resolve_model_invalid_format() {
    ...
    let result = client.resolve_model("test_model", "2k", "invalid_format").await;
...
async fn test_resolve_texture_with_resolution_fallback_4k_to_2k() {
    ...
    let files_mock = server.mock("GET", "/files/test_texture")
        .with_status(200)
        .with_body(r#"{
            "Diffuse": {
                "2k": {
    ...
    let info_mock = server.mock("GET", "/info/test_texture")
        .with_status(200)
        .with_body(r#"{
            "name": "Test Texture",
            "categories": ["Textures"],
    ...
    let client = PolyHavenClient::new_with_base_url(&server.url()).unwrap();
    let result = client.resolve_texture("test_texture", "4k", &vec!["albedo".to_string()]).await;
...
async fn test_resolve_texture_with_resolution_fallback_8k_to_4k_to_2k() {
    ...
    let client = PolyHavenClient::new_with_base_url(&server.url()).unwrap();
    let result = client.resolve_texture("test_texture", "8k", &vec!["albedo".to_string()]).await;
...
async fn test_resolve_texture_with_map_name_alternatives() {
    ...
    let client = PolyHavenClient::new_with_base_url(&server.url()).unwrap();
    let result = client.resolve_texture("test_texture", "2k", &vec!["albedo".to_string()]).await;
    
    assert!(result.is_ok(), "Should match 'diff' as alternative for 'albedo'");
    let asset = result.unwrap();
...
async fn test_resolve_texture_with_format_preference_exr_over_jpg() {
    ...
    assert!(result.is_ok());
    let asset = result.unwrap();
    assert!(asset.urls["albedo"].ends_with(".exr"), "Should prefer EXR over JPG");
...
async fn test_resolve_hdri_with_resolution_fallback_8k_to_4k() {
    ...
    let files_mock = server.mock("GET", "/files/test_hdri")
        .with_status(200)
        .with_body(r#"{
            "hdri": {
                "4k": {
    ...
    let info_mock = server.mock("GET", "/info/test_hdri")
        .with_status(200)
        .with_body(r#"{"name": "Test HDRI", "categories": ["HDRIs"], "tags": [], "download_count": 100}"#)
        .create_async()
        .await;
...
async fn test_resolve_hdri_prefers_exr_over_hdr() {
    ...
    assert!(result.is_ok());
    let asset = result.unwrap();
    assert!(asset.urls["hdri"].ends_with(".exr"), "Should prefer EXR over HDR");
...
async fn test_resolve_hdri_falls_back_to_hdr_if_no_exr() {
    ...
    assert!(result.is_ok());
    let asset = result.unwrap();
    assert!(asset.urls["hdri"].ends_with(".hdr"), "Should use HDR if EXR unavailable");
...
async fn test_resolve_model_with_resolution_fallback() {
    ...
    let files_mock = server.mock("GET", "/files/test_model")
        .with_status(200)
        .with_body(r#"{
            "glb_model": {
                "2k": {
    ...
    let info_mock = server.mock("GET", "/info/test_model")
        .with_status(200)
        .with_body(r#"{"name": "Test Model", "categories": ["Models"], "tags": [], "download_count": 50}"#)
        .create_async()
        .await;
