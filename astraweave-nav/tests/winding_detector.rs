...
fn detect_downward_triangles() {
    ...
    check_triangle("Triangle 1", Triangle {
    ...
    check_triangle("Triangle 2", Triangle {
        a: Vec3::new(0.0, 0.0, 0.0),
        b: Vec3::new(-1.0, 0.0, 0.0),
        c: Vec3::new(0.0, 0.0, -1.0),
    });
    ...
    check_triangle("Triangle 1 (horizontal)", Triangle {
        a: Vec3::new(0.0, 0.0, 0.0),
        b: Vec3::new(1.0, 0.0, 0.0),
        c: Vec3::new(0.0, 0.0, 1.0),
    });
    check_triangle("Triangle 2 (vertical)", Triangle {
        a: Vec3::new(0.0, 0.0, 0.0),
    ...
    check_triangle("Triangle 1 (up)", Triangle {
        a: center,
        b: Vec3::new(-1.0, 0.0, 1.0),
        c: Vec3::new(1.0, 0.0, 1.0),
    });
    check_triangle("Triangle 2 (left)", Triangle {
        a: center,
        b: Vec3::new(-1.0, 0.0, -1.0),
        c: Vec3::new(-1.0, 0.0, 1.0),
    });
    check_triangle("Triangle 3 (right)", Triangle {
        a: center,
        b: Vec3::new(1.0, 0.0, 1.0),
        c: Vec3::new(1.0, 0.0, -1.0),
    });
    ...
    check_triangle("Horizontal bar 1", Triangle {
        a: Vec3::new(0.0, 0.0, 0.0),
        b: Vec3::new(0.0, 0.0, 1.0),
        c: Vec3::new(3.0, 0.0, 0.0),
    });
    check_triangle("Horizontal bar 2", Triangle {
        a: Vec3::new(3.0, 0.0, 0.0),
        b: Vec3::new(0.0, 0.0, 1.0),
        c: Vec3::new(3.0, 0.0, 1.0),
    });
    check_triangle("Vertical bar 1", Triangle {
        a: Vec3::new(0.0, 0.0, 1.0),
        b: Vec3::new(0.0, 0.0, 4.0),
        c: Vec3::new(1.0, 0.0, 1.0),
    });
    check_triangle("Vertical bar 2", Triangle {
        a: Vec3::new(1.0, 0.0, 1.0),
        b: Vec3::new(0.0, 0.0, 4.0),
    ...
    check_triangle("Bottom strip 1", Triangle {
        a: Vec3::new(0.0, 0.0, 0.0),
        b: Vec3::new(0.0, 0.0, 1.0),
        c: Vec3::new(4.0, 0.0, 0.0),
    });
    check_triangle("Bottom strip 2", Triangle {
        a: Vec3::new(4.0, 0.0, 0.0),
        b: Vec3::new(0.0, 0.0, 1.0),
        c: Vec3::new(4.0, 0.0, 1.0),
    });
    check_triangle("Left strip 1", Triangle {
        a: Vec3::new(0.0, 0.0, 1.0),
        b: Vec3::new(0.0, 0.0, 3.0),
        c: Vec3::new(1.0, 0.0, 1.0),
    });
    check_triangle("Left strip 2", Triangle {
        a: Vec3::new(1.0, 0.0, 1.0),
        b: Vec3::new(0.0, 0.0, 3.0),
        c: Vec3::new(1.0, 0.0, 3.0),
    });
    check_triangle("Right strip 1", Triangle {
        a: Vec3::new(3.0, 0.0, 1.0),
        b: Vec3::new(3.0, 0.0, 3.0),
        c: Vec3::new(4.0, 0.0, 1.0),
    });
    check_triangle("Right strip 2", Triangle {
        a: Vec3::new(4.0, 0.0, 1.0),
        b: Vec3::new(3.0, 0.0, 3.0),
        c: Vec3::new(4.0, 0.0, 3.0),
    });
    check_triangle("Top strip 1", Triangle {
        a: Vec3::new(0.0, 0.0, 3.0),
        b: Vec3::new(0.0, 0.0, 4.0),
        c: Vec3::new(4.0, 0.0, 3.0),
    });
    check_triangle("Top strip 2", Triangle {
    ...
    check_triangle("Area 1 triangle 1", Triangle {
        a: Vec3::new(0.0, 0.0, 0.0),
        b: Vec3::new(0.0, 0.0, 3.0),
        c: Vec3::new(3.0, 0.0, 0.0),
    });
    check_triangle("Area 1 triangle 2", Triangle {
        a: Vec3::new(3.0, 0.0, 0.0),
        b: Vec3::new(0.0, 0.0, 3.0),
        c: Vec3::new(3.0, 0.0, 3.0),
    });
    check_triangle("Passage", Triangle {
        a: Vec3::new(3.0, 0.0, 1.0),
        b: Vec3::new(3.0, 0.0, 2.0),
        c: Vec3::new(4.0, 0.0, 1.5),
    });
    check_triangle("Area 2 triangle 1", Triangle {
        a: Vec3::new(4.0, 0.0, 0.0),
        b: Vec3::new(4.0, 0.0, 3.0),
        c: Vec3::new(7.0, 0.0, 0.0),
    });
    check_triangle("Area 2 triangle 2", Triangle {
    ...
    check_triangle("60° slope triangle", Triangle {
        a: Vec3::new(0.0, 0.0, 0.0),
        b: Vec3::new(1.0, 0.0, 0.0),
