...
mod validation_result_tests {
    ...
    fn test_validation_impossible_movement() {
        ...
        assert!(
            ...
            "Should significantly reduce trust"
        );
    }
    ...
    fn test_validation_memory_tamper() {
        ...
        assert!(
            ...
            "Memory tampering should heavily reduce trust"
        );
    }
    ...
    fn test_validation_multiple_anomalies() {
        ...
        assert!(
            !result.is_valid,
            "Multiple severe anomalies should invalidate"
        );
...
mod llm_validation_tests {
    ...
    fn test_sanitize_content_filtering() {
        ...
        assert!(
            output.starts_with("SAFE:"),
            "Should prefix suspicious content"
        );
    }
}
...
mod behavioral_tests {
    ...
    fn test_trust_score_decay() {
        ...
        assert!(
            double_result.trust_score < single_result.trust_score,
