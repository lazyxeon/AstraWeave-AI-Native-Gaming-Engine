...
mod tests {
    ...
    fn test_behavior_tick_system_updates_status() {
        ...
        world.insert(entity, CBehaviorGraph {
            graph,
            context,
            status: BehaviorStatus::Running,
            running_node: None,
        ...
        let bg = world.get::<CBehaviorGraph>(entity).expect("Component should exist");
    ...
    fn test_behavior_tick_system_multiple_entities() {
        ...
        world.insert(entity1, CBehaviorGraph {
        ...
        world.insert(entity2, CBehaviorGraph {
        ...
        world.insert(entity3, CBehaviorGraph {
    ...
    fn test_behavior_plugin_adds_system() {
        ...
        let graph = BehaviorGraph::new(BehaviorNode::Action("succeed".to_string()));
        let context = create_test_context();
        app.world.insert(entity, CBehaviorGraph {
            graph,
            context,
            status: BehaviorStatus::Running,
            running_node: None,
        ...
        let bg = app.world.get::<CBehaviorGraph>(entity).expect("Component should exist");
        assert_eq!(bg.status, BehaviorStatus::Success);
    }
    ...
    fn test_behavior_running_node_tracking() {
        ...
        let bg = world.get::<CBehaviorGraph>(entity).expect("Component should exist");
        assert!(bg.running_node.is_some(), "running_node should be set after tick");
    }
